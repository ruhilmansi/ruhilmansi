...
heyoo, i'm mansi, cs undergraduate at banasthali vidyapith. lately I’m into low level stuff (learning rust) and building things with `<code/>`  sometimes it works, sometimes it doesn’t.
